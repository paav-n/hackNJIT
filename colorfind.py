...
def slice_box_objects(n_image, img_with, img_height, cla, b, sco, category="candy", confident=0.7):
    objects = []
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            for image_path in TEST_IMAGE_PATHS:
                ...
                objs = slice_box_objects(image_np, width, height, classes, boxes, scores, "candy", 0.7)
